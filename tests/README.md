...
Tests for the scoring engine per rubric v1.0 (`docs/SCORING_RUBRIC.md`).
...
| `10-integrity-checks.json` | §7: all four integrity rules (recall inflation, generic answer, contradiction, uniform max) |
| `11-output-contract.json` | §8: complete output contract — all fields, rounding, integrityFlags names |
...
3. **Developing midpoint** §5.4 says "midpoint of the tier below." Developing range is 3.1–5.5, midpoint = (3.1+5.5)/2 = 4.3. This appears to be what the rubric intends (4.3). Foundational midpoint = (1.0+3.0)/2 = 2.0. Fixtures 07A and 07B assume these values.
